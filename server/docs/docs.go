                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/speed_web.SpeedInfo"
                        }
                    }
                ],
                "responses": {
